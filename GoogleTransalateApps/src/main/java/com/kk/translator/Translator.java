...
public class Translator {
	...
	public static void main(String[] args) throws Exception {
		...
		String inputWord="Twinkle, twinkle, little star, for your tiny spark,ow could he see where to go,if you did not twinkle so?In the dark blue sky you keep,ften through my curtains peep or you never shut your eye,ill the sun is in the sky.kaushal"; 
		
		String word = http.callUrlAndParseResult("en", "hi", inputWord);
